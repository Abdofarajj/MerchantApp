    ...
    <Screen>
      ...
      >
        <View style={styles.list}>
          <Text style={[theme.fonts.labelLarge, styles.inputLabel]}>
            تعديل بيانات مستخدم الجهاز
          </Text>
          <View style={styles.section}>
            <Text style={[theme.fonts.labelSmall, styles.inputLabel]}>
        ...
        <View style={styles.list}>
          ...
          >
            <Text style={[theme.fonts.bodyMedium, styles.buttonTextStyle]}>
              تعديل كلمة المرور
            </Text>
          </Button>
        </View>
